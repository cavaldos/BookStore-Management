...
public class Main_Employee extends javax.swing.JFrame {
        ...
        menu.addEventMenuSelected(new EventMenuSelected() {
            ...
            public void selected(int index) {
                if (index <= 0) {
                    ...
                    setForm(new TableCategory());
                } else if (index == 3) {
                    setForm(new TableAuthor());
                } else if (index == 4) {
                    setForm(new TablePublisher());
                } else if (index == 5) {
                    setForm(new ViewSheet());
                } else if (index == 6) {
                    setForm(new ImportSheet());
                } else if (index == 7) {
                    setForm(new ViewOrder());
                } else if (index == 8) {
                    setForm(new CreateOrder());
                } else if (index == 9) {
                    setForm(new CustomerTable());
                }
            }
        });
    }
    ...
    private void initComponents() {
        ...
        panelBorder1 = new store.view.employee.ui.swing.PanelBorder();
        menu = new store.view.employee.ui.component.Menu();
        header1 = new store.view.employee.ui.component.Header();
        mainPanel = new javax.swing.JPanel();
        formHome1 = new store.view.employee.ui.form.FormHome();
    ...
    private store.view.employee.ui.component.Header header1;
    private javax.swing.JPanel mainPanel;
    private store.view.employee.ui.component.Menu menu;
    private store.view.employee.ui.swing.PanelBorder panelBorder1;
